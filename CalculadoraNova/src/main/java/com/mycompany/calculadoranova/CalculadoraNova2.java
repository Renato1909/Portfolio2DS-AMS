 ...
 * @author Admin
 */
public class CalculadoraNova2 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CalculadoraNova2.class.getName());

    /**
     * Creates new form CalculadoraNova2
     */
    public CalculadoraNova2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtcampo2.addActionListener(this::txtcampo2ActionPerformed);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CalculadoraNova2().setVisible(true));
    }
